								...
								<div class="card-body m-5" id="printThis">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['national_id'] ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?>">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['resident_type']==1 ? 'Alive' : 'Deceased' ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['alias'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= date('F d, Y', strtotime($resident['birthdate'])) ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['age'] ?> yrs. old">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                            <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['civilstatus'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['gender'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['purok'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                            <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['voterstatus'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['identified_as'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['phone'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                            <input type="text" class="form-control fw-bold" style="font-size:15px" value="<?= $resident['email'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <textarea class="form-control fw-bold" style="font-size:15px" rows="3"><?= ucwords(trim($resident['occupation'])) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <textarea class="form-control fw-bold" style="font-size:15px" rows="3"><?= ucwords(trim($resident['address'])) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <textarea class="form-control fw-bold" style="font-size:15px" rows="3"><?= ucwords(trim($resident['remarks'])) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
