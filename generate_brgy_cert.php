                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-3">
                                            <div class="text-center p-3">
                                                ...
                                                <h5 class="mt-3  mb-0 "><?= ucwords($row['name']) ?><b>VISSION:</b><i> The Eco-Tourism Hub of Leyte with a progressive, God-loving and empowered community, governed by strong and proactive leaders working collaboratively with the stakeholders towards inclusive growth and sustainable development.</i></h5><br>
                                                <h5 class="mb-2 "><?= ucwords($row['position']) ?> <b>MISSION:</b><i> To uplift the quality of life of the populace through sustainable economic, social, infrastructure, institutional and environmental development.</i></h5>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <h2 class="mt-3">Given this <span class="fw-bold" style="font-size:25px"><?= date('m/d/Y') ?></span> at the office of the Punong Barangay, <span class="fw-bold" style="font-size:25px"><?= ucwords($brgy) ?></span>
