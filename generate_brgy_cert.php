                ...
                <div class="card-body m-5" id="printThis">
                  <div class="d-flex flex-wrap justify-content-center" style="border-bottom:1px solid red">
                    ...
                    <div class="text-center">
                        ...
                        <h1 class="fw-bold mb-0"><i><?= ucwords($brgy) ?></i></h1>
                  ...
                  <div class="row mt-2">
                      <div class="col-md-3">
                          <div class="text-center p-3">
                              ...
                              <h5 class="mt-3  mb-0 ">
                                ...
                                <b>VISION:</b>
                              <i>
                                The Eco-Tourism Hub of Leyte with a progressive, God-loving and empowered community, governed by strong and proactive leaders working collaboratively with the stakeholders towards inclusive growth and sustainable development.
                              </i>
                            </h5>
                            <br>
                              <h5 class="mb-2 ">
                                ...
                                <b>MISSION:</b>
                                <i>
                                  To uplift the quality of life of the populace through sustainable economic, social, infrastructure, institutional and environmental development.
                                </i>
                              </h5>
                          </div>
                      </div>
                      <div class="col-md-9">
                          ...
                          <h2 class="mt-3" style="text-indent: 40px;">This is to certify that
                          <span class="fw-bold" style="font-size:25px">
                            <?= fullname($resident) ?>
                          </span>, is a permanent resident of
                              <span class="fw-bold" style="font-size:25px"><?= ucwords(
                              	$brgy
                              ) ?></span> and that he/she is known to me to be of good moral character.
                          </h2>
                          ...
                          <h2 class="mt-3">Given this <span class="fw-bold" style="font-size:25px"><?= date(
                          	"m/d/Y"
                          ) ?></span> at the office of the Punong Barangay,
                          <span class="fw-bold" style="font-size:25px">
                          <?= ucwords($brgy) ?>
                        </span>
                                this Municipality, Philippines.</h2></span></h2>
                            <h2 class="text-uppercase" style="margin-top:180px;">NOT VALID WITHOUT SEAL:</h2>
                        </div>
                        <div class="col-md-12">
                            <div class="p-3 text-right mr-3">
                                <h2 class="fw-bold mb-0 text-uppercase"><?= ucwords(
                                	$captain["name"]
                                ) ?></h2>
                                <p class="mr-3">PUNONG BARANGAY</p>
                            </div>
                            <div class="p-3 text-left">
                                <h2 class="fw-bold mb-0 text-uppercase"><?= empty($sec["name"])
                        ...
                        <div class="col-md-12 d-flex flex-wrap justify-content-end">
                            <div class="p-3 text-center">
                                ...
                                <h2 class="fw-bold mb-0"><?= fullname($resident) ?></h2>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="name" value="<?= ucwords(
                        	$resident["firstname"] .
                        		" " .
                        		$resident["middlename"] .
                        		" " .
