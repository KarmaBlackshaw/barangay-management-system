...
<head>
	...
	<title>Barangay Collection Payment - Barangay Services Management System</title>
</head>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Barangay Collection Payment</h2>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Collection Payment Informations</div>
									</div>
								</div>
								<div class="card-body">
