                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit Contact Number" onclick="editPrecinct(this)" data-precinct="<?= $row['precinct'] ?>" data-details="<?= $row['details'] ?>" data-id="<?= $row['id'] ?>">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a type="button" data-toggle="tooltip" href="model/remove_precinct.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this Contact Number?');" class="btn btn-link btn-danger" data-original-title="Remove">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/edit_precinct.php">
                                <div class="form-group">
                                    <label>Contact Number</label>
                                    <input type="text" class="form-control" id="precinct" placeholder="Enter Contact Number" name="precinct" required>
                                </div>
                                <div class="form-group">
                                    <label>Contact Number Details(Optional)</label>
                                    <textarea class="form-control" id="details" placeholder="Enter Contact Number Details" name="details"></textarea>
                                </div>
