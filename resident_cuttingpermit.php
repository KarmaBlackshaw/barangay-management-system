													 ...
													 <?php if(isset($_SESSION['username'])):?>
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_cuttingpermit.php?id=<?= $row['id'] ?>" class="btn btn-link btn-primary" data-original-title="Generate Permit">
																	<i class="fas fa-file-alt"></i>
																</a>
																<?php if(isset($_SESSION['username']) && $_SESSION['role']=='administrator'): ?>
																<a type="button" data-toggle="tooltip" href="model/remove_request.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this Cutting permit?');" class="btn btn-link btn-danger" data-original-title="Remove">
